...
- **`v1.5.0 "Bedrock"` onward — the RustyNES-parity ladder — IN PROGRESS.** A second, parallel
  ...
  **RELEASED 2026-07-11**), a real debugger module (`v1.7.0`, **RELEASED 2026-07-12** — a
  memory panel + the panel-plumbing scaffold; `v1.8.0` continues the depth pass), Lua/TAS +
  ...
  iOS apps plus dormant monetization scaffolding (`v1.14.0`-`v1.18.0`) — and a PGO/BOLT
  pipeline last (`v1.19.0`). Tracked in lockstep against RustyNES's own continuing development
  via `to-dos/LOCKSTEP-CHECKLIST.md`, not a frozen snapshot target. Full detail in

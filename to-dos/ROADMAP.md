...
| **T-04-D** | Group D — DMA / HDMA. **Started:** 7 GP-DMA tests (`D1.01`, `D1.02`, `D1.06`, `D1.07`, `D1.10`), which found the unmodelled `$43xB` scratch latch. Left: `D1.05`/`D1.13`-`D1.15`, the `D2` HDMA block, and `D1.08`/`D3` which need care | ~28 | **a research top-up**: the dossier's DMA/HDMA sub-agent never returned, so `D1`/`D2` are under-sourced |

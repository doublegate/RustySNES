...
stands at **245 tests — 233 scoring + 12 golden — with 232 passing, 1 skipped, 100.00%**,
cross-validated against Mesen2 and snes9x. Coverage is **251 of 443** enumerated assertions (`docs/accuracysnes-coverage.md`). The tickets below carry the rest of the enumeration in

...
stands at **246 tests — 234 scoring + 12 golden — with 233 passing, 1 skipped, 100.00%**,
cross-validated against Mesen2 and snes9x. Coverage is **252 of 443** enumerated assertions (`docs/accuracysnes-coverage.md`). The tickets below carry the rest of the enumeration in

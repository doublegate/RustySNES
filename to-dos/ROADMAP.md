...
- **`v1.5.0 "Bedrock"` onward — the RustyNES-parity ladder — IN PROGRESS.** A second, parallel
  ...
  **RELEASED 2026-07-11**), a real debugger module (`v1.7.0`-`v1.8.0`), Lua/TAS + TAStudio
  depth (`v1.9.0`), an HD-pack builder (`v1.10.0`), RetroAchievements hardcore/leaderboard/

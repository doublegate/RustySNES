...
.proc test_a5_18
    .a16
    .i16
    ; Three BRKs, and nothing returns from any of them. The vector points at the instruction
    ; after the BRK, so the span holds BRK + the runtime's trampoline + the loop, and only
    ; BRK's own frame size differs between the two arms.
    rep #$30
    .a16
    .i16
    lda #.LOWORD(@resume)
    ...
    ; Enter emulation once out here purely to force S into page 1, so both spans abandon their
    ; frames in the same place; SH stays $01 on the way back out.
    sec
    xce               ; -> emulation
    .a8
    .i8
    ...
    .i16
    tsc
    sta f:$7E00A0    ; S before the span, restored after it
    sep #$30
    .a8
    .i8
    jsr hv_begin
...
@loop:
    brk
    .byte $EA        ; BRK's signature byte, never executed -- nothing returns to it
@resume:
    dey
    bne @loop
    clc
    ...
    .i16
    lda f:$7E0048     ; V_H1 = elapsed dots
    sta f:$7E00A2    ; native baseline
    ; record slot 272: 3x BRK, native (8 cycles each)
    sta f:$7EE420
    ...
    lda f:$7E00A0
    tcs
    ; --- emulation: 3-byte frames, the same loop ---
    ; Re-point the vector at THIS span's resume label. There is one trampoline pointer, so a
    ; second span needs a second write -- and it is out here, not inside the measurement.
    ; Leaving it aimed at the native span's label sends the emulation BRK back into the native
    ; loop with its own counter, which hangs the battery outright rather than reading wrong.
    rep #$30
    .a16
    .i16
    lda #.LOWORD(@eresume)
...
@eresume:
    ...
    lda f:$7E0048     ; V_H1 = elapsed dots
    sta f:$7E00A4
    ; record slot 273: 3x BRK, emulation (7 cycles each)
    sta f:$7EE422
    rep #$30
    .a16
    .i16
    ...
    sec
    sbc f:$7E00A4
    ; record slot 274: 3x (native - emulation), expect 6
    sta f:$7EE424
    cmp #$0004
    bcs :+
    jmp @fail1
  ...
  :
    ...
    jml test_restore
@fail1:
    ; BRK did not push one extra byte in native mode (8 cycles vs 7): the native frame is PBR, PCH, PCL, P and the emulation frame is the same without PBR, so a core pushing the same three bytes in both reads zero here
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
...
.proc test_a2_13
    ...
    plb
    lda f:$7E01B0
    ; record slot 134: A2.05 the 16-bit value read across the page boundary
    sta f:$7EE30C
    cmp #$1234
    bne :+
    sep #$20
...
.proc test_b1_03
    ...
    lda f:$7E0048     ; V_H1 = elapsed dots
    sta f:$7E0098
    ; record slot 128: 16 NOP, absolute
    sta f:$7EE300
    sep #$30
    .a8
    .i8
    ...
    sec
    sbc f:$7E0098
    ; record slot 129: 16 XBA - 16 NOP = 16 internal cycles
    sta f:$7EE302
    cmp #$0016
    bcs :+
    jmp @fail1
...
.proc test_b1_04
    ...
    lda f:$7E0048     ; V_H1 = elapsed dots
    sta f:$7E009A
    ; record slot 130: DMA 32B from a MEMSEL-fast bank
    sta f:$7EE304
    ...
    .i16
    lda f:$7E0048     ; V_H1 = elapsed dots
    ; record slot 131: DMA 32B from a slow bank
    sta f:$7EE306
...
@iloop:
    ...
    .a16
    lda f:$7E0126
    ; record slot 132: V counter maximum with interlace enabled
    sta f:$7EE308
...
@wh:
    ...
    and #$01FF
    sta f:$7E012A
    ; record slot 133: H position when the H-IRQ was observed
    sta f:$7EE30A
...
@dloop:
    ...
    lda f:$7E0168
    ; record slot 139: B3 shortest interval in dots (the stall-free loop period)
    sta f:$7EE316
    lda f:$7E016A
    ; record slot 140: B3 longest interval in dots
    sta f:$7EE318
    lda f:$7E016C
...
.proc test_a5_s35
    .a16
    .i16
    ; BRL flat 4 — expect 30 clocks per iteration.
    ; Derivation: 4 cycles / 3 accesses; taken unconditionally and never penalised, where an 8-bit               branch pays +1 for being taken and, in emulation mode, +1 more for crossing a page.
    ; Baseline is 1 NOP(s) per iteration so the fetch overhead cancels; the difference is
    ; the instruction's own extra cost. Raw spans are recorded so a failure can be inspected.
    rep #$30
    .a16
    ...
    lda f:$7E0048     ; V_H1 = elapsed dots
    sta f:$7E0096
    ; record slot 231: baseline NOPs, absolute
    sta f:$7EE3CE
    ; --- the opcode under test ---
    sep #$30
    .a8
    ...
    sec
    sbc f:$7E0096
    ; record slot 232: measured minus baseline
    sta f:$7EE3D0
    cmp #$001E
    bcs :+
    jmp @fail1
...
; provenance: Contested (the dossier records a repeating 32x$00 / 32x$FF fill and marks it chip-dependent and informational; RustySNES, snes9x and Mesen2 all boot APU RAM uniformly zero instead)
.proc test_e4_11
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 96: E4.11 ARAM $8000 at power-on (pattern predicts $00)
    sta f:$7EE2C0
    lda f:$7E0101
    and #$00FF
    ; record slot 97: E4.11 ARAM $8020 at power-on (pattern predicts $FF)
    sta f:$7EE2C2
    lda f:$7E0102
    and #$00FF
    ; record slot 98: E4.11 ARAM $8040 at power-on (pattern predicts $00)
    sta f:$7EE2C4
    ; The middle byte is what separates the two live answers; the outer two rule out a core
    ; that filled everything with $FF.
    sep #$30
    .a8
    .i8
    lda f:$7E0100
    ...
    ora f:$7E0102
    bne :+
    lda #$03          ; variant 1 = uniformly zero; no power-on pattern modelled
    sta f:$7EE010
    jml test_restore
    :
    lda f:$7E0100
    ...
    cmp #$FF
    bne :+
    lda #$05          ; variant 2 = the documented 32x$00 / 32x$FF pattern
    sta f:$7EE010
    jml test_restore
    :
    lda #$07          ; variant 3 = neither; the raw bytes are in slots 96-98
    sta f:$7EE010
    jml test_restore
    bra @pass
@timeout:
...
; provenance: Documented (SNESdev Wiki SPC700 reference and fullsnes, both flagging DIV as valid only for quotients up to 511; the values past it follow E1.03's overflow formula)
.proc test_e1_07
    .a16
    .i16
    ; --- $03FE / 2: quotient 511, the last value the 9-bit result can hold ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_ok:
    ...
    lda #$A5
    sta APUIO0
    ; Stash it: the second upload overwrites the same three mailbox bytes.
    sep #$20
    .a8
    lda f:$7E0100
    sta f:$7E01B4
    lda f:$7E0101
    sta f:$7E01B5
    ; --- $0400 / 2: quotient 512, one past the boundary ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_ov:
    ...
    lda f:$7E01B4
    and #$00FF
    ; record slot 99: E1.07 quotient of $03FE / 2 (true 511)
    sta f:$7EE2C6
    lda f:$7E01B5
    and #$00FF
    ; record slot 103: E1.07 remainder of $03FE / 2 (true 0)
    sta f:$7EE2CE
    lda f:$7E0100
    and #$00FF
    ; record slot 135: E1.07 quotient of $0400 / 2 (true 512 — cannot be represented)
    sta f:$7EE30E
    lda f:$7E0101
    and #$00FF
    ; record slot 136: E1.07 remainder of $0400 / 2 (true 0)
    sta f:$7EE310
    ; The control first: at 511 the division is still exact.
    sep #$20
    .a8
    lda f:$7E01B4
    cmp #$FF
  ...
  :
    ...
    jmp @fail2
  :
    ; And one step past it, where both halves go wrong together.
    lda f:$7E0100
    cmp #$FF
    beq :+
    jmp @fail3
...
@pass:
    ...
    jml test_restore
@fail1:
    ; $03FE / 2 did not give a quotient of 511 (low byte $FF) — the divide is wrong below the boundary, so nothing can be concluded about what happens above it
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
...
@fail2:
    ...
    jml test_restore
@fail3:
    ; $0400 / 2 returned a quotient other than $FF: a core computing YA/X and truncating gives $00 here, which is the documented-invalid case behaving as though it were valid
    sep #$20
    .a8
    lda #$06
    sta f:$7EE010
    jml test_restore
@fail4:
    ; $0400 / 2 did not return the overflow branch's Y = X + (YA - (X<<9)) % (256 - X) = 2. A core computing a true remainder returns 0 — correct arithmetic, and not what the hardware does past a quotient of 511
    sep #$20
    .a8
    lda #$08
    sta f:$7EE010
...
; provenance: Documented (SNESdev Wiki SPC700 timers and fullsnes: a 0->1 on a $F1 timer-enable bit resets that timer's stage-2 divider and stage-3 output counter)
.proc test_e3_02
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 137: E3.02 timer 0 ticks over the interval, with no restart (the control)
    sta f:$7EE312
    lda f:$7E0101
    and #$00FF
    ; record slot 138: E3.02 the same interval, read after a 0->1 on the enable bit
    sta f:$7EE314
    ; The control first: the interval has to count, or 'it reads zero' below means nothing.
    lda f:$7E0100
    and #$00FF
    cmp #$0003
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; timer 0 did not accumulate a usable number of ticks over this interval, so the reset check below would pass against nothing — a zero here would also mean disabling the timer clears the counter, which phase 1 is arranged to detect
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; the counter did not read zero after the enable bit went 0->1. A core treating the bit as pause/resume returns the control's count here instead, so compare slots 113 and 114: equal means the transition was ignored
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: of the four gaussian additions the first cannot overflow, the second wraps in 16 bits and the third saturates)
.proc test_e6_09
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0101
    and #$00FF
    ; record slot 205: E6.09 ENVX at shift 12 (the arming guard)
    sta f:$7EE39A
    lda f:$7E0102
    and #$00FF
    ; record slot 206: E6.09 OUTX for four maximally-negative gaussian taps
    sta f:$7EE39C
    ; The guard: a silent voice reads $00, which is neither sign and would pass a range test
    ; written carelessly.
    lda f:$7E0101
    and #$00FF
    cmp #$007C
  ...
  :
    ...
    jmp @fail1
  :
    ; +$3FF8 rather than -$4000: the sign is the whole assertion.
    lda f:$7E0102
    and #$00FF
    cmp #$0001
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the envelope was not at full scale, so OUTX is scaled by something this test does not know and its sign is not safe to read
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; four maximally-negative taps interpolated to a negative output, so the gaussian accumulator is saturating or working in wider arithmetic rather than wrapping in 16 bits — a sample written to exploit the wrap plays back without the sign inversion it expects
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Contested (the dossier names four nibble patterns and asks what a decoder makes of each without stating an expected value for any of them; the row's content is the measurement)
.proc test_e6_11
    .a16
    .i16
    ; --- nibbles 79797979 ---
...
@ran_v7777CC44:
    ...
    lda f:$7E0102     ; OUTX
    sta f:$7E01FB
    ; The envelope from the last run stands for all four: the setup is identical.
    sep #$20
    .a8
    lda f:$7E0101
    sta f:$7E01FC
    ...
    lda f:$7E01F8
    and #$00FF
    ; record slot 197: E6.11 OUTX for nibbles 79797979
    sta f:$7EE38A
    lda f:$7E01F9
    and #$00FF
    ; record slot 198: E6.11 OUTX for nibbles 77997799
    sta f:$7EE38C
    lda f:$7E01FA
    and #$00FF
    ; record slot 199: E6.11 OUTX for nibbles 77779999
    sta f:$7EE38E
    lda f:$7E01FB
    and #$00FF
    ; record slot 200: E6.11 OUTX for nibbles 7777CC44
    sta f:$7EE390
    lda f:$7E01FC
    and #$00FF
    ; record slot 201: E6.11 ENVX on the last vector (the arming guard)
    sta f:$7EE392
    ; Four zeroes from a voice that never sounded look exactly like a decoder that outputs
    ; silence, so the envelope is what says the readings are readings.
    lda f:$7E01FC
    and #$00FF
    cmp #$007C
    bcs :+
  ...
  :
    sep #$20
    .a8
    lda #$03          ; variant 1 = all four captured; slots 197-200 are the vectors
    sta f:$7EE010
    jml test_restore
    bra @pass
@timeout:
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the voice was not at full scale when OUTX was read, so the four waveform readings are scaled by an envelope this test does not know and are not comparable with anything
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie: the SPC700's 1.024 MHz clock and the DSP's 32 kHz output rate fix the ratio at 32 CPU cycles per output sample)
.proc test_e10_01
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 192: E10.01 ENVX before key-off (the arming guard)
    sta f:$7EE380
    lda f:$7E0101
    and #$00FF
    ; record slot 193: E10.01 timer 0 ticks for a full release ramp
    sta f:$7EE382
    ; The envelope has to have been at full scale, or the poll exits immediately.
    lda f:$7E0100
    and #$00FF
    cmp #$007C
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; 254 samples at 32 cycles each is 8128 cycles, which is ten 768-cycle ticks.
    lda f:$7E0101
    and #$00FF
    cmp #$0009
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the envelope was not at full scale when the voice was keyed off, so the ramp below was shorter than the arithmetic assumes — or absent entirely
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; a full release ramp did not take the ten timer-0 ticks that 254 samples at 32 SPC cycles each come to. The envelope was full scale and the release step is fixed, so what is wrong is the sample period: 64 cycles would read 5 after wrapping, and 16 would read 5 outright
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 7: E1.14 timer 0 ticks over 256 NOP (the baseline)
    sta f:$7EE20E
    lda f:$7E0101
    and #$00FF
    ; record slot 125: E1.14 timer 0 ticks over 256 XCN
    sta f:$7EE2FA
    ; The baseline first: it says the timer ran at the rate the arithmetic below assumes.
    lda f:$7E0100
    and #$00FF
    cmp #$0003
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; And XCN's five cycles put its block at ten ticks; four or six would read 8 or 12.
    lda f:$7E0101
    and #$00FF
    cmp #$0009
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; 256 NOP did not cost the four timer-0 ticks that 512 cycles at 128 cycles per tick come to, so either NOP is not two cycles or the timer is not running at T0DIV = 1 — and the XCN reading below is then measured against nothing
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; 256 XCN did not cost the ten timer-0 ticks five cycles each come to. The baseline passed, so the timer and the block length are right and the per-instruction cost is not: at 128 cycles per tick this reading is off by at least a whole cycle per XCN
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (SNESdev Wiki SPC700 reference and fullsnes: DBNZ dp,rel reads its operand, decrements it and writes it back, and $FD-$FF are read-to-clear)
.proc test_e2_04
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 162: E2.04 timer 0 ticks over the interval, read directly (the control)
    sta f:$7EE344
    lda f:$7E0101
    and #$00FF
    ; record slot 163: E2.04 the same interval, read after DBNZ touched the counter
    sta f:$7EE346
    ; The control first: the interval has to count, or 'it reads zero' below means nothing.
    lda f:$7E0100
    and #$00FF
...
@pass:
    ...
    jml test_restore
@fail1:
    ; timer 0 did not accumulate a usable number of ticks over this interval, so the check below would pass against nothing
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; the counter still held its count after DBNZ addressed it, so DBNZ never read its target: it is being implemented as a decrement rather than as a read-modify-write
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the noise generator's step rate is set by FLG bits 0-4, and a voice's pitch register does not participate)
.proc test_e9_03
    .a16
    .i16
    ; --- run 1: VxPITCH = $1000 ---
...
@ran_lo:
    ...
    .a8
    lda f:$7E0102
    sta f:$7E01DC     ; OUTX, before the second upload overwrites the mailbox copy
    ; --- run 2: VxPITCH = $2000, everything else identical ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_hi:
    ...
    lda f:$7E01DC
    and #$00FF
    ; record slot 168: E9.03 noise OUTX at VxPITCH = $1000
    sta f:$7EE350
    lda f:$7E0102
    and #$00FF
    ; record slot 169: E9.03 noise OUTX at VxPITCH = $2000
    sta f:$7EE352
    ; The guard: two silences are equal too, and would pass the comparison having compared
    ; nothing at all.
    sep #$20
    .a8
    lda f:$7E01DC
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the noise voice produced no output at all, so the comparison below would be between two silences rather than between two noise streams
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; the two runs produced different noise output, and they differ only in VxPITCH — so the voice's pitch is reaching the noise generator, whose rate comes from FLG bits 0-4 alone
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the noise shift register resets to $4000, with taps bit0 XOR bit1 feeding bit 14)
.proc test_e9_01
    .a16
    .i16
    sep #$20
    ...
    lda f:V_RESTARTED
    beq :+
    ; SKIP: the seed this reads is the power-on one, and E9.02 steps the register away from it
    sep #$20
    .a8
    lda #VERDICT_SKIP
    sta f:V_TEST_RESULT
...
@ran:
    ...
    lda f:$7E0102
    and #$00FF
    ; record slot 180: E9.01 noise OUTX with the LFSR frozen at its seed
    sta f:$7EE368
    ; $4000 shifted left one is $8000 — full-scale negative — so the top bit must be set.
    sep #$20
    .a8
    lda f:$7E0102
    and #$80
    ...
    jmp @fail1
  :
    ; And near full scale, which a small seed would not be.
    rep #$30
    .a16
    .i16
    lda f:$7E0102
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the frozen noise output is not negative, so the LFSR was not seeded with $4000: a seed of zero gives silence and any small seed gives a small positive or negative value
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; the frozen noise output is negative but nowhere near full scale, so the seed has the right sign and the wrong magnitude
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the BRR header is ssssffle, shift in bits 7-4, and a nibble decodes as (nibble << shift) >> 1)
.proc test_e5_01
    .a16
    .i16
    ; --- shift $8 ---
...
@ran_s8:
    ...
    .a8
    lda f:$7E0102
    sta f:$7E01E4     ; OUTX, before the second upload overwrites the mailbox copy
    ; --- shift $9: the same block with one nibble changed ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_s9:
    ...
    lda f:$7E01E4
    and #$00FF
    ; record slot 178: E5.01 OUTX with header shift $8
    sta f:$7EE364
    lda f:$7E0102
    and #$00FF
    ; record slot 179: E5.01 OUTX with header shift $9
    sta f:$7EE366
    ; The guard: zero doubles to zero, so a silent voice would satisfy the ratio below without
    ...
    jmp @fail1
  :
    ; Raising the shift by one doubles the sample. A core reading the shift from bits 3-0 sees
    ; zero in both headers and returns the same amplitude twice.
    rep #$30
    .a16
    .i16
    lda f:$7E01E4
    and #$00FF
    asl a             ; twice the shift-$8 amplitude
    sta f:$7E01E6
    lda f:$7E0102
    and #$00FF
    sec
    sbc f:$7E01E6     ; how far the shift-$9 reading is from exactly double
    cmp #$8000
    bcc :+
    eor #$FFFF
    inc a             ; negate: take the magnitude
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the shift-$8 block produced no output, so the comparison below would be between two silences rather than between two amplitudes
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; raising the header's shift nibble by one did not roughly double the decoded amplitude — an unchanged reading means the shift is being taken from a different part of the header
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: key-off begins the release ramp and does not halt BRR decoding, which continues to follow loop points and set ENDX)
.proc test_e5_10
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda #$A5
    sta APUIO0
    ; The guard first: the voice has to have actually been released.
    sep #$20
    .a8
    lda f:$7E0101
    cmp #$00
    ...
    jmp @fail1
  :
    ; ENDX was cleared at key-off, so anything here was set by a decode that happened after.
    rep #$30
    .a16
    .i16
    lda f:$7E0100
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the envelope was not zero after key-off, so the voice was never released and the ENDX reading below would be about an ordinary playing voice
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; ENDX bit 0 did not set again after the voice was released: the core stopped decoding on key-off instead of only releasing the envelope. E7.08 cannot see this — both behaviours take the envelope to zero
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
.proc test_e4_06
    .a16
    .i16
    ; Two blocks in one upload: data to $0250, verifier to $0280 through a non-zero continue.
    rep #$30
    .a16
    .i16
    phk
    plb
    ; Block A: the data, transferred first and left in place for the verifier to read back.
    lda #.loword(apu_dataA_58)
    sta f:V_APU_SRC
    sep #$20
    .a8
    lda #^apu_dataA_58
    ...
    sta f:V_APU_DEST2
    lda #$0280
    sta f:V_APU_ENTRY     ; the final close jumps here, into block B
    jsl apu_upload_2block_far
    ; Clear port 0 so a stale handshake byte cannot read as the program's done marker.
    sep #$20
    .a8
    lda #$00
    sta APUIO0
    ; Wait for the verifier's done marker, bounded: a continue a core botched never runs it.
    rep #$30
    .a16
    .i16
    ldx #$0000
...
@ran:
    ...
    lda #$A5
    sta APUIO0
    ; Record the read-back bytes, then assert they are block A's — proof the continue transferred
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 202: E4.06 read-back of APU $0250 (block A byte 0, expect $C3)
    sta f:$7EE394
    lda f:$7E0101
    and #$00FF
    ; record slot 203: E4.06 read-back of APU $0251 (block A byte 1, expect $3C)
    sta f:$7EE396
    lda f:$7E0102
    and #$00FF
    ; record slot 204: E4.06 read-back of APU $0252 (block A byte 2, expect $99)
    sta f:$7EE398
    sep #$20
    .a8
    lda f:$7E0100
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the verifier read back the wrong first byte from block A's destination — the non-zero close did not transfer block A to $0250, or jumped instead of continuing
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
...
.proc test_e4_08
    .a16
    .i16
    ; Phase 1: set FIR[0] = $A5 as a known baseline, then release to the IPL. The zero-fill on
    ; IPL re-entry does not touch DSP registers, so $A5 survives into the poke phase below.
    rep #$30
    .a16
    .i16
    phk
...
@ran_base:
    ...
    ; block B, reached through the non-zero continue, reads $0F back and reports it. It must now
    ; read $7E, not the $A5 baseline — which it can only do if the IPL poke reached the DSP.
    rep #$30
    .a16
    .i16
    phk
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 234: E4.08 DSP register $0F read back after the IPL poke (expect $7E)
    sta f:$7EE3D4
    sep #$20
    .a8
    lda f:$7E0100
...
@pass:
    ...
    jml test_restore
@fail1:
    ; DSP register $0F did not change from its $A5 baseline to the poked $7E — the IPL store to $00F2/$00F3 did not reach the DSP register file
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: a mid-playback SRCN change takes the new entry's start address, or its loop address if the voice has already passed a loop point)
.proc test_e5_12
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 209: E5.12 OUTX with SRCN left alone (the control)
    sta f:$7EE3A2
    lda f:$7E0101
    and #$00FF
    ; record slot 210: E5.12 OUTX after a mid-note SRCN change
    sta f:$7EE3A4
    ; The control: the same delays, no write, so entry 0 is still playing.
    lda f:$7E0100
    and #$00FF
    cmp #$0068
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; And with the write, entry 1's loop address: nibble +2, so around $1F.
    lda f:$7E0101
    and #$00FF
    cmp #$0018
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the voice was not playing entry 0 after the same delays with SRCN untouched, so it moved on its own and the phase below cannot be attributed to the write
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; a mid-note SRCN change did not land on the new entry's loop address. Around $6E means the write never took effect at all; around $3F means the entry's start address was taken instead, which is what a voice still inside its key-on delay would do and this one is long past that
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: KON is write-triggered and self-clears ~63 clocks later; only KOFF and FLG bit 7 are level-sensitive)
.proc test_e8_05
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda #$A5
    sta APUIO0
    ; $7F means the voice keyed on once and its envelope escaped the key-on delay; $00 means a
    ; held KON bit kept re-keying it, so the envelope never left zero.
    rep #$30
    .a16
    .i16
    lda f:$7E0100
...
@pass:
    ...
    jml test_restore
@fail1:
    ; a held KON register bit kept re-keying the voice — its envelope never escaped the key-on delay, so KON is being treated as a level the DSP re-consults rather than a write-once edge
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the per-voice mix clamps to 16 bits after each addition rather than accumulating and clamping once)
.proc test_e9_15
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 207: E9.15 echo byte 1 with one voice (the guard)
    sta f:$7EE39E
    lda f:$7E0101
    and #$00FF
    ; record slot 208: E9.15 echo byte 1 with two voices at the same level
    sta f:$7EE3A0
    ; One voice has to be loud and positive but not already at the limit, or adding a second
    ; says nothing about how the addition behaves.
    lda f:$7E0100
    and #$00FF
    cmp #$0040
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; And two of them must clamp at the limit rather than summing past it into the other sign.
    lda f:$7E0101
    and #$00FF
    cmp #$0040
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; one voice alone did not read back as a large positive value below the limit — it was silent, negative, or already saturated, and in every one of those cases the two-voice reading below is uninterpretable
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; two voices summed to a negative value, so the per-voice mix is wrapping instead of saturating after each addition — several loud voices at once would produce a sign-inverted crack where hardware distorts
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the echo buffer holds four bytes per sample, a 16-bit left sample followed by a 16-bit right one)
.proc test_e9_05
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 170: E9.05 echo buffer byte 1 (L high) — $FF means nothing was written
    sta f:$7EE354
    lda f:$7E0101
    and #$00FF
    ; record slot 171: E9.05 echo buffer byte 2 (R low)
    sta f:$7EE356
    lda f:$7E0102
    and #$00FF
    ; record slot 172: E9.05 echo buffer byte 3 (R high)
    sta f:$7EE358
    ; The left channel first: it is the guard. Still $FF means echo never wrote at all, and
    ; the right channel's bytes below would then be reporting the marker, not a layout.
    sep #$20
    .a8
    lda f:$7E0100
    cmp #$FF
    ...
    jmp @fail1
  :
    ; The right channel is silent, so its two bytes must be written zeroes.
    lda f:$7E0101
    cmp #$00
    beq :+
    jmp @fail2
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the echo buffer's second byte still held the $FF marker, so nothing was written and the right-channel checks below would be about the paint rather than about the layout
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; echo buffer byte 2 is not the right channel's low byte: a core writing two bytes per entry leaves the $FF marker here, and one writing right-then-left leaves the signal
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
    jml test_restore
@fail3:
    ; echo buffer byte 3 is not the right channel's high byte, so the entry is not four bytes of left-then-right
    sep #$20
    .a8
    lda #$06
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc [ERRATA]: the echo buffer address is 16-bit and wraps, so a buffer that runs past $FFFF continues at $0000 over page zero and the IPL shadow)
.proc test_e9_09
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 263: E9.09 echo byte 1 inside the buffer proper, at $F901
    sta f:$7EE40E
    lda f:$7E0101
    and #$00FF
    ; record slot 264: E9.09 the same byte one wrap later, at $0001
    sta f:$7EE410
    lda f:$7E0102
    and #$00FF
    ; record slot 265: E9.09 its low byte at $0000, which E9.12 masks
    sta f:$7EE412
    ; The guard: echo has to have written the buffer at all. Without this a page zero that
    ; never changed and an echo that never ran read exactly alike.
    lda f:$7E0100
    and #$00FF
    cmp #$0040
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; First the specific wrong model, which gets its own code: an address masked or clamped
    ; inside the ESA page leaves the paint untouched.
    sep #$20
    .a8
    lda f:$7E0101
    cmp #$A5
    ...
    jmp @fail2
  :
    ; Then the row itself. Every entry is the same four bytes, so the wrapped one must equal
    ; the one inside the buffer -- 'something changed' is not the same claim.
    rep #$30
    .a16
    .i16
    lda f:$7E0101
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the echo buffer's own second byte is not the large positive value the constant sample puts there, so echo writes never happened and the page zero reading below is about nothing
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; page zero still held the paint after a full buffer cycle, so the echo write pointer never left the ESA page — it is being masked or clamped at the 16-bit boundary instead of wrapping through it
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
    jml test_restore
@fail3:
    ; page zero changed but does not hold the same echo entry the buffer does, so whatever reached it is not this buffer wrapping through the 16-bit boundary
    sep #$20
    .a8
    lda #$06
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the echo FIR keeps a separate eight-sample history and accumulator per channel; only the coefficients are shared)
.proc test_e9_13
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 173: E9.13 echo byte 1 (L high) with feedback on — $FF means nothing was written
    sta f:$7EE35A
    lda f:$7E0101
    and #$00FF
    ; record slot 174: E9.13 echo byte 2 (R low)
    sta f:$7EE35C
    lda f:$7E0102
    and #$00FF
    ; record slot 175: E9.13 echo byte 3 (R high) — $00 or $FF is near-silence
    sta f:$7EE35E
    ; The guard: if echo never wrote, the right half is still $FF and would fail below for a
    ; reason that has nothing to do with crosstalk.
    sep #$20
    .a8
    lda f:$7E0100
    cmp #$FF
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the echo buffer's left half still held the $FF marker, so nothing was written and the right-channel checks below would be about the paint rather than about the filter
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; the left echo channel's high byte is zero, so the signal this test is checking for leakage of is itself too small for the comparison below to mean anything
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
    jml test_restore
@fail3:
    ; the right echo channel's magnitude reached the left's, although only the left was ever fed and feedback is on — the FIR is sharing history or accumulator between the channels
    sep #$20
    .a8
    lda #$06
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the decoded sample is clamped to 16 bits and then stored as 15, so +4000h..+7FFFh becomes -4000h..-1 and the sign is lost)
.proc test_e5_06
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 260: E5.06 negative readings out of 64, driving filter 1 with +7 nibbles
    sta f:$7EE408
    lda f:$7E0101
    and #$00FF
    ; record slot 261: E5.06 non-zero readings out of 64 (the sounding guard)
    sta f:$7EE40A
    lda f:$7E0102
    and #$00FF
    ; record slot 262: E5.06 the last of the 64 readings
    sta f:$7EE40C
    ; The guard: sixty-four silences would report zero negatives and look like a clean clamp.
    lda f:$7E0101
    and #$00FF
    cmp #$0001
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; The row. A decoder that saturates leaves the buffer constant, so its readings all carry
    ; the same sign -- either all 64 negative or all 64 positive, depending on what the
    ; interpolator makes of a pinned buffer. Only a value that wraps swings both ways.
    lda f:$7E0100
    and #$00FF
    cmp #$0001
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; not one of the sixty-four OUTX readings was non-zero, so the voice never sounded and the sign test below is about silence rather than about the decoder
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the BRR decoder advances on the pitch clock regardless of the envelope; voices never actually stop decoding)
.proc test_e5_13
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 240: E5.13 ENVX after key-off release (the guard: the voice is silent)
    sta f:$7EE3E0
    lda f:$7E0101
    and #$00FF
    ; record slot 241: E5.13 ENDX cleared then re-read while released
    sta f:$7EE3E2
    ; The guard: a released voice reads ENVX $00, so the ENDX below is not just a playing voice.
    lda f:$7E0100
    and #$00FF
    cmp #$0000
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; A released voice keeps decoding and re-crosses its end block: voice 0's ENDX bit reads set.
    ; A core that halts a silent voice's decoder leaves it clear. Mask to bit 0 — other voices may
    ; carry leftover ENDX bits from an earlier test, which is why the raw slot can read $03.
    lda f:$7E0101
    and #$0001
    cmp #$0001
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the voice was not silent after key-off, so its ENDX below says nothing about decoding while released
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; voice 0 stopped setting ENDX after key-off — its BRR decoder halted, but decoding continues independently of the envelope and the sample position must keep advancing
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: GAIN mode 7 increases +32 per sample below $600 and +8 above, comparing the internal envelope latch unsigned)
.proc test_e7_13
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0101
    and #$00FF
    ; record slot 233: E7.13 ENVX under GAIN bent-increase, in the slow region past $600
    sta f:$7EE3D2
    ; Past $600 the slope is +8, not +32: after ~96 samples the envelope is near $780, not
    ; saturated. A core that ignores the $600 break climbs +32 throughout and saturates at $7FF.
    lda f:$7E0101
    and #$00FF
    cmp #$0068
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; GAIN bent-increase did not land in its slow region. Below $68 the envelope never reached the $600 break, so the second slope was never tested; at $7F it saturated, which is what a core that climbs a flat +32 and ignores the break does
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: GAIN linear-decrease subtracts $20 per tick and clamps the envelope to zero on underflow, comparing the internal envelope unsigned)
.proc test_e7_17
    .a16
    .i16
    rep #$30
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 236: E7.17 ENVX parked at full scale under direct gain (the guard)
    sta f:$7EE3D8
    lda f:$7E0101
    and #$00FF
    ; record slot 237: E7.17 ENVX after linear-decrease drove the envelope through zero
    sta f:$7EE3DA
    ; The guard: the envelope has to have been high for the zero below to mean it was pulled down.
    lda f:$7E0100
    and #$00FF
    cmp #$007C
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; Linear-decrease past zero clamps to zero and holds; a core that wraps -$20 reads ~$7E here.
    lda f:$7E0101
    and #$00FF
    cmp #$0000
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the envelope was not at full scale before switching to linear-decrease, so the value below says nothing about an underflow
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; linear-decrease did not clamp at zero on underflow — a wrapping subtraction leaves ~$7E0 in the envelope and ENVX reads near $7E
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; E7.18 — ENVX is E>>4
; provenance: Documented (fullsnes and anomie's DSP doc: VxENVX = envelope >> 4, a seven-bit value with bit 7 always clear)
.proc test_e7_18
    .a16
    .i16
    rep #$30
...
@pass:
    ...
    jml test_restore
@fail1:
    ; ENVX was not the envelope shifted right four: at envelope $400 a >>4 reads $40, a >>5 reads $20, and a >>3 reads $80 — bit 7 set, which the envelope's eleven bits can never produce
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: attack rate $F fires every sample with a step of +1024, rather than the +32 on a counter tick every other rate uses)
.proc test_e7_04
    .a16
    .i16
    ; --- attack rate $F ---
...
@ran_fast:
    ...
    .a8
    lda f:$7E0101
    sta f:$7E01EC     ; ENVX, before the second upload overwrites the mailbox copy
    ; --- attack rate $0, the same interval ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_slow:
    ...
    lda f:$7E01EC
    and #$00FF
    ; record slot 182: E7.04 ENVX after attack rate $F
    sta f:$7EE36C
    lda f:$7E0101
    and #$00FF
    ; record slot 183: E7.04 ENVX after attack rate $0
    sta f:$7EE36E
    ; Rate $F crosses the whole range in two samples, so by any settle at all it is parked.
    lda f:$7E01EC
    and #$00FF
    cmp #$0070
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; And rate $0 is the slowest there is, so over the same interval it has barely moved.
    lda f:$7E0101
    and #$00FF
    cmp #$0000
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; attack rate $F did not reach full scale: it steps +1024 every sample and crosses the envelope's whole range in two, so a core applying the ordinary a*2+1 rate lands short
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; attack rate $0 climbed a long way over an interval rate $F needs two samples for — the two rates are not being distinguished at all
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: release steps -8 per sample regardless of ADSR, which is why a custom release has to be built from GAIN)
.proc test_e7_09
    .a16
    .i16
    ; --- sustain rate 0 ---
...
@ran_sr0:
    ...
    .a8
    lda f:$7E0101
    sta f:$7E01F0     ; ENVX, before the second upload overwrites the mailbox copy
    ; --- sustain rate 31, the fastest in the table ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_sr31:
    ...
    lda f:$7E01F0
    and #$00FF
    ; record slot 184: E7.09 ENVX mid-release with sustain rate 0
    sta f:$7EE370
    lda f:$7E0101
    and #$00FF
    ; record slot 185: E7.09 ENVX mid-release with sustain rate 31
    sta f:$7EE372
    ; The guard: the reading has to be mid-ramp. At $00 the ramp is over and at $7F it has not
    ; begun, and in both cases every release rate looks the same.
    lda f:$7E01F0
    and #$00FF
    cmp #$0001
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the sustain-rate-0 run was not caught mid-release, so the comparison below would hold for any release rate at all
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the decay phase indexes the counter table at d*2+16, stepping E -= 1 then E -= E>>8)
.proc test_e7_05
    .a16
    .i16
    ; --- decay rate 0, index 16 ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_d0:
    ...
    .a8
    lda f:$7E0101
    sta f:$7E01F4     ; ENVX, before the second upload overwrites the mailbox copy
    ; --- decay rate 7, index 30: much faster ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_d7:
    ...
    lda f:$7E01F4
    and #$00FF
    ; record slot 186: E7.05 ENVX mid-decay at decay rate 0 (index 16)
    sta f:$7EE374
    lda f:$7E0101
    and #$00FF
    ; record slot 187: E7.05 ENVX mid-decay at decay rate 7 (index 30)
    sta f:$7EE376
    ; The guard: run 1 has to be mid-decay. At the bottom or the top, both rates look alike.
    lda f:$7E01F4
    and #$00FF
    cmp #$0010
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; And the fast rate must have got substantially further down over the same interval.
    lda f:$7E01F4
    and #$00FF
    sec
    sbc f:$7E0101
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the slow decay was not caught in progress — at the bottom of its ramp or still at the top, both decay rates produce the same reading and the gap below means nothing
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; the two decay rates left the envelope in nearly the same place, so the rate field is not being indexed as d*2+16 — using d verbatim puts both runs in the slow half of the table
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the sustain phase indexes the counter table with the ADSR2 rate field directly, unlike decay's d*2+16)
.proc test_e7_06
    .a16
    .i16
    ; --- sustain rate 0 ---
...
@ran_sr0:
    ...
    .a8
    lda f:$7E0101
    sta f:$7E01F8     ; ENVX, before the second upload overwrites the mailbox copy
    ; --- sustain rate 31 ---
    rep #$30
    .a16
    .i16
...
@ran_sr31:
    ...
    lda f:$7E01F8
    and #$00FF
    ; record slot 188: E7.06 ENVX at sustain rate 0 (verbatim: never fires)
    sta f:$7EE378
    lda f:$7E0101
    and #$00FF
    ; record slot 189: E7.06 ENVX at sustain rate 31
    sta f:$7EE37A
    ; Rate 0 indexed verbatim never fires, so the envelope is still exactly where it parked.
    sep #$20
    .a8
    lda f:$7E01F8
    cmp #$7F
    ...
    jmp @fail1
  :
    ; And the fastest rate must have moved a long way, or a core ignoring the field entirely
    ; would pass on the first assertion alone. 31 rather than a mid-table rate because sustain
    ; decay is exponential: from full scale it barely moves at first, and rate 16 only reached
    ; $76 over this same window.
    rep #$30
    .a16
    .i16
    lda f:$7E0101
...
@pass:
    ...
    jml test_restore
@fail1:
    ; sustain rate 0 let the envelope decay, so the field is not being used verbatim — any positive offset turns rate 0 into a real rate and every held note fades
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; the fastest sustain rate left the envelope at or near full scale, so the sustain rate is not being consulted at all
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the decay phase ends when (E >> 8) equals the ADSR2 sustain level, giving a boundary of $100 per level)
.proc test_e7_07
    .a16
    .i16
    ; --- sustain level 3 ---
...
@ran_sl3:
    ...
    .a8
    lda f:$7E0101
    sta f:$7E01FC     ; ENVX, before the second upload overwrites the mailbox copy
    ; --- sustain level 5 ---
    rep #$30
    .a16
    .i16
...
@ran_sl5:
    ...
    lda f:$7E01FC
    and #$00FF
    ; record slot 190: E7.07 ENVX parked at sustain level 3
    sta f:$7EE37C
    lda f:$7E0101
    and #$00FF
    ; record slot 191: E7.07 ENVX parked at sustain level 5
    sta f:$7EE37E
    ; Level 3 parks on the $100*(l+1) boundary, which is $400, so ENVX is in $40-$4F.
    lda f:$7E01FC
    and #$00FF
    cmp #$0040
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; And level 5 on $600. The bands do not overlap and neither reaches the ends of the range,
    ; so a stuck envelope cannot satisfy both.
    lda f:$7E0101
    and #$00FF
    cmp #$0060
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; sustain level 3 did not park the envelope on its $100*(l+1) boundary — anywhere else means a different field is being compared, or the comparison fires after the decrement rather than before it
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; sustain level 5 did not park the envelope on its $100*(l+1) boundary, so the boundary does not track the level
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: the attack phase indexes the counter table at a*2+1 and steps the envelope by +32)
.proc test_e7_03
    .a16
    .i16
    ; --- attack rate $8, index 17 ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_a8:
    ...
    .a8
    lda f:$7E0101
    sta f:$7E0200     ; ENVX, before the second upload overwrites the mailbox copy
    ; --- attack rate $C, index 25 ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_ac:
    ...
    lda f:$7E0200
    and #$00FF
    ; record slot 141: E7.03 ENVX mid-attack at rate $8 (index 17)
    sta f:$7EE31A
    lda f:$7E0101
    and #$00FF
    ; record slot 142: E7.03 ENVX mid-attack at rate $C (index 25)
    sta f:$7EE31C
    ; The guard: run 1 has to be mid-attack. At either end both rates read the same.
    lda f:$7E0200
    and #$00FF
    cmp #$0001
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; And the faster rate must have climbed substantially further over the same interval.
    lda f:$7E0101
    and #$00FF
    sec
    sbc f:$7E0200
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the slower attack was not caught in progress — at full scale or still at zero, both rates read alike and the comparison below is empty. A core indexing with `a` verbatim lands here, in the slow half of the table for both settings
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; the two attack rates left the envelope in nearly the same place, so the field is not being doubled before it indexes the table
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Contested (the dossier records the GAIN-sourced boundary as [ERRATA]; RustySNES takes it from ADSR2 instead, which E7.07 asserts, so which behaviour is right is not settled here)
.proc test_e7_12
    .a16
    .i16
    ; --- GAIN bits 7-5 = 0 ---
...
@ran_g0:
    ...
    .a8
    lda f:$7E0101
    sta f:$7E0204     ; ENVX, before the second upload overwrites the mailbox copy
    ; --- GAIN bits 7-5 = 5, with ADSR2 unchanged ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_g5:
    ...
    lda f:$7E0204
    and #$00FF
    ; record slot 143: E7.12 park level with GAIN bits 7-5 = 0
    sta f:$7EE31E
    lda f:$7E0101
    and #$00FF
    ; record slot 181: E7.12 park level with GAIN bits 7-5 = 5
    sta f:$7EE36A
    ; Equal means the boundary came from ADSR2, which is what the register is for. Different
    ; means GAIN reached a comparison it has no business in.
    sep #$20
    .a8
    lda f:$7E0204
    cmp f:$7E0101
    bne :+
    lda #$03          ; variant 1 = same level both times; the boundary is ADSR2's
    sta f:$7EE010
    jml test_restore
    :
    lda #$05          ; variant 2 = the level followed GAIN; the erratum is modelled
    sta f:$7EE010
    jml test_restore
    bra @pass
@timeout:
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 256: E8.01 which voices the KON sweep started (bit 7 = voice 0)
    sta f:$7EE400
    ; Count the set bits: how many of the eight writes the DSP acted on. The mask itself is in
    ; the measurement channel above, so a failure here can be read back to the exact pattern.
    ldx #$0000
    ldy #$0008
@e801bit:
    lsr a
...
@e801next:
    ...
    bne @e801bit
    txa
    ; record slot 257: E8.01 how many of the eight voices the sweep started
    sta f:$7EE402
    cmp #$0002
    bcs :+
    jmp @fail1
...
@pass:
    ...
    jml test_restore
@fail1:
    ; eight KON writes 24 SPC cycles apart started more than five voices, so more than four examinations fell inside the burst -- KON is being read every output sample rather than every second one. A count of zero or one instead means the sweep never ran
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 227: E8.02 timer 2 ticks to a non-zero ENVX, voice already sounding (baseline)
    sta f:$7EE3C6
    lda f:$7E0101
    and #$00FF
    ; record slot 228: E8.02 the same, measured from a KON write
    sta f:$7EE3C8
    lda f:$7E0102
    and #$00FF
    ; record slot 229: E8.02 ENVX after the release, before the second key-on (the arming guard)
    sta f:$7EE3CA
    ; The voice has to be silent before it is keyed on again. If the release has not finished,
    ; the poll below exits on its first pass and reports a delay of nothing.
    lda f:$7E0102
    and #$00FF
    cmp #$0000
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; The baseline has to be small, or the poll loop is slower than the delay it measures and
    ; the subtraction below is meaningless.
    lda f:$7E0100
    and #$00FF
    cmp #$0000
    bcs :+
  ...
  :
    ...
    jmp @fail2
  :
    ; And the key-on has to cost about seven more ticks, one tick being one sample: the
    ; five-sample delay, the KON write itself, and the first sample on which ENVX climbs.
    rep #$30
    .a16
    .i16
    lda f:$7E0101
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the envelope had not reached zero before the second key-on, so the poll started with ENVX already non-zero and measured the loop rather than the delay
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; polling ENVX on an already-sounding voice took more than four 16-cycle ticks, so the loop is slow enough to swamp a five-sample delay and phase B measures the loop rather than the key-on
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Documented (fullsnes and anomie's DSP doc: KON re-enters the key-on sequence unconditionally, resetting the BRR pointer and zeroing the envelope, whether or not the voice was already playing)
.proc test_e8_03
    .a16
    .i16
    ; --- left alone: the attack has been climbing for 24 delay blocks ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_held:
    ...
    lda f:$7E0101
    sta f:$7E01F4     ; ENVX, before the second upload overwrites the mailbox copy
    ; --- keyed on again one delay block before the reading ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_retrig:
    ...
    lda f:$7E01F4
    and #$00FF
    ; record slot 114: E8.03 ENVX after 24 blocks of attack, left alone
    sta f:$7EE2E4
    lda f:$7E0101
    and #$00FF
    ; record slot 115: E8.03 ENVX one block after a second KON on the same playing voice
    sta f:$7EE2E6
    ; The guard: without a climb there is nothing for a restart to undo.
    lda f:$7E01F4
    and #$00FF
    cmp #$0020
    bcs :+
  ...
  :
    ...
    jmp @fail1
  :
    ; And the restart has to have zeroed it, not merely lowered it.
    lda f:$7E0101
    and #$00FF
    cmp #$0000
    bcs :+
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the untouched run's envelope had barely climbed, so both runs read low whatever KON does and the comparison below would hold for a core that ignores it
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; writing KON to a voice that was already playing left its envelope near where it had climbed to, so the write was treated as 'start if stopped' — a driver retriggering a held note would hear it continue instead of restarting from silence
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
; provenance: Contested (KON/KOFF are sampled every second output sample, so whether a short pulse is seen depends on where the poll falls inside it -- which makes the outcome phase-dependent rather than fixed, the same hedge E8.05 and E8.06 carry as "usually")
.proc test_e8_07
    .a16
    .i16
    rep #$30
...
; provenance: Documented (fullsnes and anomie's DSP doc: KON zeroes the envelope before its attack, and KOFF outranks KON, so the pair silences immediately where KOFF alone ramps)
.proc test_e8_10
    .a16
    .i16
    ; --- run 1: KOFF alone, read while the release ramp is still running ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_off:
    ...
    .a8
    lda f:$7E0101
    sta f:$7E01E0     ; ENVX, before the second upload overwrites the mailbox copy
    ; --- run 2: KOFF and KON together, same interval ---
    rep #$30
    .a16
    .i16
    phk
...
@ran_both:
    ...
    lda f:$7E01E0
    and #$00FF
    ; record slot 176: E8.10 ENVX after KOFF alone (must still be ramping)
    sta f:$7EE360
    lda f:$7E0101
    and #$00FF
    ; record slot 177: E8.10 ENVX after KOFF + KON together
    sta f:$7EE362
    ; The guard: if the ramp already finished, both runs read zero and the comparison below
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the KOFF-only run had already reached silence, so the settle is too long and the comparison below cannot distinguish the two paths
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; KOFF and KON written together left the envelope mid-ramp, exactly as KOFF alone did — the KON's zeroing of the envelope was dropped along with its attack
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
...
.proc test_e9_02
    ...
    lda f:V_RESTARTED
    beq :+
    ; SKIP: the sign flip is only predictable from the $4000 seed, which this row itself consumed
    sep #$20
    .a8
    lda #VERDICT_SKIP
    sta f:V_TEST_RESULT
...
@ran:
    ...
    lda f:$7E0100
    and #$00FF
    ; record slot 258: E9.02 noise OUTX with the LFSR frozen at its seed
    sta f:$7EE404
    lda f:$7E0101
    and #$00FF
    ; record slot 259: E9.02 noise OUTX one LFSR step later
    sta f:$7EE406
    ; Two guards before the row's own assertions. The first fixes the starting point: this is
    ; E9.01's reading, and without it there is no known state to have stepped away from.
    sep #$20
    .a8
    lda f:$7E0100
    and #$80
    ...
    jmp @fail1
  :
    ; The second: the register has to have actually moved. A 48-sample window cannot contain
    ; zero multiples of 32, so this failing means the rate table or the counter is wrong, not
    ; that the noise output is shaped wrongly.
    lda f:$7E0100
    cmp f:$7E0101
    bne :+
    jmp @fail2
  :
    ; The row. One step right must move bit 14 out of the sign position, so a full-scale
    ; negative reading becomes positive.
    lda f:$7E0101
    and #$80
    cmp #$00
    beq :+
    jmp @fail3
  :
    ; And at about half scale, or a quarter if the window caught two steps -- both are what a
    ; right shift produces, and neither is what a core that merely re-centred the value gives.
    rep #$30
    .a16
    .i16
    lda f:$7E0101
...
@pass:
    ...
    jml test_restore
@fail1:
    ; the frozen noise reading is not negative, so the LFSR was not at the $4000 seed and the step below has no known starting point -- E9.01 covers that reading itself
    sep #$20
    .a8
    lda #$02
    sta f:$7EE010
    jml test_restore
@fail2:
    ; enabling the noise clock for 48 output samples did not change the output at all, so the LFSR never stepped and the sign test below would be comparing the seed with itself
    sep #$20
    .a8
    lda #$04
    sta f:$7EE010
    jml test_restore
@fail3:
    ; one step of the noise register did not flip the output's sign, so the register's top bit is not the output's sign bit: the core is emitting the 15-bit value directly, which is the DC-heavy noise the errata's highpass remark exists to exclude
    sep #$20
    .a8
    lda #$06
    sta f:$7EE010
    jml test_restore
@fail4:
    ; the noise output turned positive after one step but is not the seed shifted right once or twice, so the output is some other function of the register than its top fifteen bits
    sep #$20
    .a8
    lda #$08
    sta f:$7EE010
...
; provenance: Documented (fullsnes and the SNESdev Wiki: the sprite tile budget is 34 per line and Time Over is raised by the fetch phase, so it reads set by the start of the line the sprites paint on)
.proc test_c7_06
    .a16
    .i16
    jmp @body
...
@body:
    ...
    phk
    plb
    ; Group C is outside bank $00, so route through the bank-$00 far-IRQ shim.
    rep #$20
    .a16
    lda #.loword(@handler)
    sta a:V_IRQ_VEC_FAR
    ...
    lda #irq_far_shim
    sta a:V_IRQ_VEC
    ; --- phase A: 20 16x16 sprites (40 tiles), sampled on the eval line V = 100 ---
    sep #$20
    .a8
    stz $2101         ; OBJSEL pair 0: 8x8 small, 16x16 large, name base 0
    stz $2102
    stz $2103
    rep #$10
    .i16
    ldx #$0000
@fill_a:
    ; X = index * 8, so the sprites tile across the line rather than stacking at one column.
    txa
    asl
    asl
    asl
    sta $2104         ; X
    cpx #$0014        ; 20 in range
    bcs @off_a
    lda #100
    bra @sety_a
@off_a:
...
@sety_a:
    ...
    cpx #$0080
    bne @fill_a
    ; High table: bit 1 of each 2-bit field is the size select for that sprite.
    stz $2102
    lda #$01
    sta $2103         ; OAMADDR = word $100
    ldx #$0000
@hi_a:
    ...
    .a8
    lda #$FF
    sta f:$7E0156     ; poison: a handler that never runs cannot look like either verdict
    stz $4207
    stz $4208         ; HTIME = 0
    lda #100
    sta $4209
...
@body:
    ...
    sep #$20
    .a8
    jsl wait_vblank_far   ; start from a known line
    lda #$01
    sta $420B
    sep #$20
    .a8
...
@clear:
    ...
    jsl wait_vblank_far   ; let the whole active display run
...
@body:
    ...
    jsl wait_vblank_far   ; let the rest of the frame, and its HDMA, complete
...
@clr13:
    ...
    lda #$01
    sta $420C
    jsl wait_vblank_far   ; a whole active display
    stz $420C
    sep #$20
    .a8
    lda f:$7E1300
...
.proc test_d1_08
    ...
    lda f:$7E0E00
    and #$00FF
    ; record slot 144: D1.08 run 1 byte
    sta f:$7EE320
    lda f:$7E0E01
    and #$00FF
    ; record slot 145: D1.08 run 2 byte
    sta f:$7EE322
...
apu_prog_3:
    .byte $CD, $EF, $BD, $E8, $FE, $8D, $03, $CD, $02, $9E, $C4, $F5
    .byte $CB, $F6, $E8, $5A, $C4, $F4, $E4, $F4, $68, $A5, $D0, $FA
    .byte $E8, $80, $C4, $F1, $5F, $C0, $FF
apu_prog_4:
    .byte $CD, $EF, $BD, $E8, $00, $8D, $04, $CD, $02, $9E, $C4, $F5
    .byte $CB, $F6, $E8, $5A, $C4, $F4, $E4, $F4, $68, $A5, $D0, $FA
    .byte $E8, $80, $C4, $F1, $5F, $C0, $FF
apu_prog_5:
...
apu_prog_11:
    ...
    .byte $60, $FE, $FE, $8F, $80, $F1, $E4, $FD, $C4, $F5, $E4, $FD
    .byte $8F, $81, $F1, $8D, $60, $FE, $FE, $8F, $80, $F1, $8F, $81
    .byte $F1, $E4, $FD, $C4, $F6, $8F, $80, $F1, $E8, $5A, $C4, $F4
...
apu_prog_15:
    ...
    .byte $FF
apu_prog_16:
    .byte $5F, $0C, $02, $C3, $88, $88, $88, $88, $88, $88, $88, $88
    ...
    .byte $F1, $5F, $C0, $FF
apu_prog_17:
    .byte $5F, $0C, $02, $C3, $79, $79, $79, $79, $79, $79, $79, $79
    .byte $CD, $EF, $BD, $E8, $03, $C5, $00, $01, $E8, $02, $C5, $01
    .byte $01, $E8, $03, $C5, $02, $01, $E8, $02, $C5, $03, $01, $E8
    .byte $00, $C5, $04, $01, $E8, $00, $C5, $05, $01, $E8, $00, $C5
    .byte $06, $01, $E8, $00, $C5, $07, $01, $E8, $6C, $C4, $F2, $E8
    ...
    .byte $F1, $5F, $C0, $FF
apu_prog_18:
    .byte $5F, $0C, $02, $C3, $77, $99, $77, $99, $77, $99, $77, $99
    .byte $CD, $EF, $BD, $E8, $03, $C5, $00, $01, $E8, $02, $C5, $01
    .byte $01, $E8, $03, $C5, $02, $01, $E8, $02, $C5, $03, $01, $E8
    .byte $00, $C5, $04, $01, $E8, $00, $C5, $05, $01, $E8, $00, $C5
    .byte $06, $01, $E8, $00, $C5, $07, $01, $E8, $6C, $C4, $F2, $E8
    ...
    .byte $F1, $5F, $C0, $FF
apu_prog_19:
    .byte $5F, $0C, $02, $C3, $77, $77, $99, $99, $77, $77, $99, $99
    .byte $CD, $EF, $BD, $E8, $03, $C5, $00, $01, $E8, $02, $C5, $01
    .byte $01, $E8, $03, $C5, $02, $01, $E8, $02, $C5, $03, $01, $E8
    .byte $00, $C5, $04, $01, $E8, $00, $C5, $05, $01, $E8, $00, $C5
    .byte $06, $01, $E8, $00, $C5, $07, $01, $E8, $6C, $C4, $F2, $E8
    ...
    .byte $F1, $5F, $C0, $FF
apu_prog_20:
    .byte $5F, $0C, $02, $C3, $77, $77, $CC, $44, $77, $77, $CC, $44
    .byte $CD, $EF, $BD, $E8, $03, $C5, $00, $01, $E8, $02, $C5, $01
    .byte $01, $E8, $03, $C5, $02, $01, $E8, $02, $C5, $03, $01, $E8
    .byte $00, $C5, $04, $01, $E8, $00, $C5, $05, $01, $E8, $00, $C5
    .byte $06, $01, $E8, $00, $C5, $07, $01, $E8, $6C, $C4, $F2, $E8
...
apu_prog_21:
    ...
    .byte $00, $C4, $F3, $8D, $20, $FE, $FE, $E8, $08, $C4, $F2, $E4
    .byte $F3, $C4, $F5, $8F, $06, $FA, $E4, $FD, $8F, $81, $F1, $E8
    .byte $5C, $C4, $F2, $E8, $01, $C4, $F3, $E8, $08, $C4, $F2, $E4
    .byte $F3, $68, $00, $D0, $F6, $8F, $80, $F1, $E4, $FD, $C4, $F6
...
apu_prog_23:
    ...
    .byte $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00
    .byte $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00
    .byte $00, $00, $00, $8F, $80, $F1, $E4, $FD, $C4, $F5, $8F, $81
    .byte $F1, $9F, $9F, $9F, $9F, $9F, $9F, $9F, $9F, $9F, $9F, $9F
...
apu_prog_36:
    ...
    .byte $4C, $C4, $F2, $E8, $00, $C4, $F3, $8D, $00, $FE, $FE, $8D
    .byte $00, $FE, $FE, $8D, $00, $FE, $FE, $8D, $00, $FE, $FE, $E8
    .byte $C5, $03, $30, $E8, $6C, $C4, $F2, $E8, $00, $C4, $F3, $8D
    .byte $00, $FE, $FE, $8D, $00, $FE, $FE, $E8, $6C, $C4, $F2, $E8
...
apu_prog_78:
    ...
    .byte $F1, $5F, $C0, $FF
apu_prog_79:
    .byte $5F, $0C, $02, $C7, $77, $77, $77, $77, $77, $77, $77, $77
    .byte $CD, $EF, $BD, $E8, $03, $C5, $00, $01, $E8, $02, $C5, $01
    .byte $01, $E8, $03, $C5, $02, $01, $E8, $02, $C5, $03, $01, $E8
    .byte $00, $C5, $04, $01, $E8, $00, $C5, $05, $01, $E8, $00, $C5
    .byte $06, $01, $E8, $00, $C5, $07, $01, $E8, $6C, $C4, $F2, $E8
    ...
    .byte $4C, $C4, $F2, $E8, $00, $C4, $F3, $8D, $00, $FE, $FE, $8D
    .byte $00, $FE, $FE, $8D, $00, $FE, $FE, $8D, $00, $FE, $FE, $8D
    .byte $00, $FE, $FE, $8D, $00, $FE, $FE, $8F, $00, $12, $8F, $00
    .byte $13, $8F, $00, $14, $E8, $09, $C4, $F2, $E4, $F3, $C4, $15
    .byte $68, $80, $E4, $12, $88, $00, $C4, $12, $E4, $15, $68, $01
    .byte $E4, $13, $88, $00, $C4, $13, $AB, $14, $E4, $14, $68, $40
    .byte $D0, $E2, $E4, $12, $C4, $F5, $E4, $13, $C4, $F6, $E4, $15
    .byte $C4, $F7, $E8, $5A, $C4, $F4, $E4, $F4, $68, $A5, $D0, $FA
    .byte $E8, $80, $C4, $F1, $5F, $C0, $FF
apu_prog_80:
    .byte $5F, $0C, $02, $83, $79, $79, $79, $79, $79, $79, $79, $79
    .byte $CD, $EF, $BD, $E8, $03, $C5, $00, $01, $E8, $02, $C5, $01
    ...
    .byte $00, $C4, $F3, $E8, $03, $C4, $F2, $E8, $10, $C4, $F3, $E8
    .byte $04, $C4, $F2, $E8, $00, $C4, $F3, $E8, $06, $C4, $F2, $E8
    .byte $00, $C4, $F3, $E8, $07, $C4, $F2, $E8, $08, $C4, $F3, $E8
    .byte $05, $C4, $F2, $E8, $00, $C4, $F3, $E8, $7C, $C4, $F2, $E8
    .byte $00, $C4, $F3, $E8, $4C, $C4, $F2, $E8, $01, $C4, $F3, $8D
    .byte $00, $FE, $FE, $E8, $4C, $C4, $F2, $E8, $00, $C4, $F3, $8D
    .byte $00, $FE, $FE, $E8, $5C, $C4, $F2, $E8, $01, $C4, $F3, $8D
    .byte $00, $FE, $FE, $8D, $00, $FE, $FE, $E8, $08, $C4, $F2, $E4
    .byte $F3, $C4, $F5, $E8, $7C, $C4, $F2, $E8, $00, $C4, $F3, $8D
    .byte $00, $FE, $FE, $8D, $00, $FE, $FE, $8D, $00, $FE, $FE, $8D
    .byte $00, $FE, $FE, $8D, $00, $FE, $FE, $8D, $00, $FE, $FE, $8D
    .byte $00, $FE, $FE, $8D, $00, $FE, $FE, $8D, $00, $FE, $FE, $8D
    .byte $00, $FE, $FE, $E8, $7C, $C4, $F2, $E4, $F3, $C4, $F6, $E8
    .byte $00, $FE, $FE, $8D, $00, $FE, $FE, $8D, $00, $FE, $FE, $8D
    .byte $00, $FE, $FE, $8D, $00, $FE, $FE, $8D, $00, $FE, $FE, $E8
...
apu_prog_106:
    ...
    .byte $5C, $C4, $F2, $E8, $01, $C4, $F3, $E8, $4C, $C4, $F2, $E8
    .byte $01, $C4, $F3, $8D, $00, $FE, $FE, $E8, $4C, $C4, $F2, $E8
    .byte $00, $C4, $F3, $E8, $7C, $C4, $F2, $E4, $F3, $C4, $F5, $E8
    .byte $08, $C4, $F2, $E4, $F3, $C4, $F6, $E8, $09, $C4, $F2, $E4
    .byte $F3, $C4, $F7, $E8, $5A, $C4, $F4, $E4, $F4, $68, $A5, $D0
    .byte $FA, $E8, $80, $C4, $F1, $5F, $C0, $FF
apu_prog_107:
...
@n_e6_09:
    .byte 18
    .byte "Gaussian sum wraps"
@n_e6_11:
    .byte 20
    .byte "BRR waveform vectors"
@n_e10_01:
    .byte 24
...
@n_e9_03:
    .byte 20
    .byte "Pitch not noise rate"
@n_e9_01:
    .byte 15
    .byte "Noise LFSR seed"
@n_e5_07:
    .byte 19
...
@n_e5_01:
    .byte 17
    .byte "BRR header layout"
@n_e5_10:
    .byte 22
    .byte "Released voice decodes"
@n_e5_11:
    .byte 23
...
@n_e4_06:
    .byte 24
    .byte "IPL multi-block continue"
@n_e4_08:
    .byte 22
    .byte "IPL DSP-poke via $00F2"
@n_e5_12:
    .byte 18
    .byte "SRCN change source"
@n_e5_02:
    .byte 22
...
@n_e9_15:
    .byte 19
    .byte "Voice mix saturates"
@n_e9_05:
    .byte 21
    .byte "Echo entry is 4 bytes"
@n_e9_09:
    .byte 22
    .byte "Echo wraps into page 0"
@n_e9_13:
    .byte 19
    .byte "L/R FIR independent"
@n_e9_10:
    .byte 23
...
@n_e5_06:
    .byte 20
    .byte "BRR wraps at 15 bits"
@n_e5_13:
    .byte 22
    .byte "Released voices decode"
@n_e7_01:
    .byte 18
    .byte "Rate 0 never fires"
@n_e7_13:
    .byte 18
    .byte "GAIN bent-increase"
@n_e7_17:
    .byte 21
    .byte "Lin-decrease clamps 0"
@n_e7_18:
    .byte 12
    .byte "ENVX is E>>4"
@n_e7_04:
    .byte 20
    .byte "Attack $F is instant"
@n_e7_09:
    .byte 21
    .byte "Release rate is fixed"
@n_e7_05:
    .byte 18
    .byte "Decay index d*2+16"
@n_e7_06:
    .byte 22
    .byte "Sustain index verbatim"
@n_e7_07:
    .byte 16
    .byte "Sustain boundary"
@n_e7_03:
    .byte 18
    .byte "Attack index a*2+1"
@n_e7_12:
    .byte 21
    .byte "GAIN sustain boundary"
@n_e7_08:
    .byte 24
    .byte "Key-off releases to zero"
@n_e8_01:
    .byte 22
    .byte "KON examined at 16 kHz"
@n_e8_02:
    .byte 22
    .byte "Key-on takes 5 samples"
@n_e8_03:
    .byte 20
    .byte "KON restarts a voice"
@n_e8_07:
    .byte 20
    .byte "KOFF pulse collapses"
@n_e8_10:
    .byte 20
    .byte "KOFF+KON cuts faster"
@n_e7_11:
    .byte 20

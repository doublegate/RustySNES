...
RustySNES's current release is **v1.31.1 "Firewall"** — the reference firewall becomes this
project's highest-priority rule and a mechanical CI gate, and an open provenance question about
`v1.30.1` is recorded rather than quietly fixed
([`docs/provenance-open-question.md`](docs/provenance-open-question.md)). **Zero emulation-core
behaviour change.** It follows **v1.31.0 "Ledger"** — all monetization removed; the project is

...
| `A6` | 15 | 10 | 0 | A6.09, A6.10, A6.12, A6.13, A6.15 |
| `A7` | 5 | 5 | 0 | — |
| `A8` | 6 | 6 | 0 | — |
| `A9` | 3 | 3 | 0 | — |
| `B1` | 5 | 4 | 0 | B1.05 |
...
**207 of 443** enumerated assertion rows covered by an on-cart test, plus **50** covered only by a rendered scene (`docs/adr/0013`) — **257 of 443** in total.

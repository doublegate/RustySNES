...
| `A5` | 15 | 7 | A5.01-08, A5.09, A5.10, A5.16, A5.18, A5.19, A5.20, A5.22 |
| `A6` | 15 | 8 | A6.02, A6.09, A6.10, A6.11, A6.12, A6.13, A6.15 |
| `A7` | 5 | 4 | A7.04 |
| `A8` | 6 | 2 | A8.01, A8.04, A8.05, A8.06 |
| `A9` | 3 | 2 | A9.03 |
| `B1` | 5 | 2 | B1.03, B1.04, B1.05 |
| `B2` | 9 | 0 | B2.01, B2.02, B2.03, B2.04, B2.05, B2.06, B2.07, B2.09, B2.10 |
| `B3` | 3 | 0 | B3.01, B3.02, B3.03 |
| `B4` | 14 | 2 | B4.01, B4.02, B4.05, B4.06, B4.07, B4.08, B4.09, B4.10, B4.11, B4.12, B4.13, B4.14 |
| `B5` | 4 | 3 | B5.04 |
...
**79 of 443** enumerated assertion rows covered by at least one test.

...
| `B4` | 14 | 10 | 0 | B4.01, B4.10, B4.11, B4.13 |
| `B5` | 4 | 4 | 0 | — |
...
**218 of 443** enumerated assertion rows covered by an on-cart test, plus **50** covered only by a rendered scene (`docs/adr/0013`) — **268 of 443** in total.

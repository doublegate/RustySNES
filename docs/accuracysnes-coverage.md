...
| `G1` | 18 | 3 | 0 | G1.01, G1.02, G1.03, G1.04, G1.05, G1.06, G1.07, G1.08, G1.09, G1.11, G1.13, G1.15, G1.16, G1.17, G1.18 |

**159 of 443** enumerated assertion rows covered by an on-cart test, plus **42** covered only by a rendered scene (`docs/adr/0013`) — **201 of 443** in total.

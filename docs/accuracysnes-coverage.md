...
| `E2` | 10 | 6 | 0 | E2.02, E2.03, E2.04, E2.10 |
...
**176 of 443** enumerated assertion rows covered by an on-cart test, plus **50** covered only by a rendered scene (`docs/adr/0013`) — **226 of 443** in total.

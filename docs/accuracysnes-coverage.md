...
| `C2` | 10 | 9 | 0 | C2.09 |
| `C3` | 10 | 6 | 0 | C3.03, C3.04, C3.05, C3.10 |
| `C4` | 5 | 0 | 5 | — |
...
**169 of 443** enumerated assertion rows covered by an on-cart test, plus **50** covered only by a rendered scene (`docs/adr/0013`) — **219 of 443** in total.

...
| `B5` | 4 | 4 | 0 | — |
| `C1` | 9 | 6 | 0 | C1.07, C1.08, C1.09 |
| `C2` | 10 | 8 | 0 | C2.09, C2.12 |
| `C3` | 10 | 5 | 0 | C3.03, C3.04, C3.05, C3.09, C3.10 |
| `C4` | 5 | 0 | 5 | — |
...
**162 of 443** enumerated assertion rows covered by an on-cart test, plus **49** covered only by a rendered scene (`docs/adr/0013`) — **211 of 443** in total.

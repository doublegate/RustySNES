...
| `C4` | 5 | 0 | 5 | — |
| `C5` | 15 | 0 | 10 | C5.06, C5.07, C5.12, C5.14, C5.15 |
| `C6` | 7 | 0 | 6 | C6.07 |
...
**160 of 443** enumerated assertion rows covered by an on-cart test, plus **48** covered only by a rendered scene (`docs/adr/0013`) — **208 of 443** in total.

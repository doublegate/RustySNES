...
| `C6` | 7 | 0 | 6 | C6.07 |
| `C7` | 16 | 3 | 5 | C7.03, C7.04, C7.05, C7.06, C7.07, C7.09, C7.12, C7.16 |
...
**165 of 443** enumerated assertion rows covered by an on-cart test, plus **50** covered only by a rendered scene (`docs/adr/0013`) — **215 of 443** in total.

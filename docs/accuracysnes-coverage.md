...
| `E1` | 15 | 11 | 0 | E1.07, E1.09, E1.11, E1.14 |
...
**174 of 443** enumerated assertion rows covered by an on-cart test, plus **50** covered only by a rendered scene (`docs/adr/0013`) — **224 of 443** in total.

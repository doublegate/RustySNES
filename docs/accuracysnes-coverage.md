...
| `D2` | 14 | 5 | 0 | D2.01, D2.02, D2.08, D2.09, D2.10, D2.11-14, D2.15, D2.16, D2.17 |
...
| `G1` | 18 | 9 | 0 | G1.03, G1.05, G1.06, G1.07, G1.13, G1.15, G1.16, G1.17, G1.18 |

**233 of 443** enumerated assertion rows covered by an on-cart test, plus **50** covered only by a rendered scene (`docs/adr/0013`) — **283 of 443** in total.

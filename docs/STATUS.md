...
| BestEffort coprocessors, real-title validated | ✅ **8 / 11** | DSP-2, DSP-3, DSP-4, ST010, ST011, S-DD1, CX4, OBC1 — each boots a real commercial title to real gameplay content (DSP-3 = SD Gundam GX, ST011 = 2-dan Morita Shougi, both new in `v1.24.0`) |

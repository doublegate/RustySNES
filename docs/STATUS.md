...
**Current release:** `v1.0.1 "Aftertouch"` (`v0.1.0 "Foundation"`,
`v0.2.0 "Persistence"`, `v0.3.0 "Continuum"`, `v0.4.0 "Completion"`, `v0.5.0 "Fidelity"`,
`v0.6.0 "Shippable"`, `v0.7.0 "Resolution"`, `v0.8.0 "Community"`, `v0.9.0 "Threshold"`, and
`v1.0.0 "Zenith"` precede it; see `to-dos/VERSION-PLAN.md` for the full ladder). `v1.0.0` closes the production-cut

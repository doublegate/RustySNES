...
**Current release:** `v0.9.0 "Threshold"` (`v0.1.0 "Foundation"`, `v0.2.0 "Persistence"`,
`v0.3.0 "Continuum"`, `v0.4.0 "Completion"`, `v0.5.0 "Fidelity"`, `v0.6.0 "Shippable"`,
`v0.7.0 "Resolution"`, and `v0.8.0 "Community"` precede it; see `to-dos/VERSION-PLAN.md` for the
full breadth-inclusive `v0.7.0`→`v1.0.0` ladder).
